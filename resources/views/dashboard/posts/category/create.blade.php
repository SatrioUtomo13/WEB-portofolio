...
@section('content')
    <div class="w-full lg:w-1/2">
        ...
        <h1 class="font-montserrat font-semibold text-4xl text-gray-800 mb-5">Add Category</h1>

        <form action="/dashboard/postCategories" method="POST">
            @csrf
            <div class="mb-6">
                <label for="category_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category Name</label>
                <input type="text" id="category_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Category name ..." required name="name" autocomplete="off" value="{{ old('name') }}" autofocus>
            </div>
