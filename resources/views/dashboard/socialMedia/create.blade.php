...
@section('content')
    <section class="w-1/2">
        ...
        <form action="/dashboard/socialmedia" method="POST">
            @csrf
            <div class="mb-6">
